    ...
    <div>
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div className="flex justify-between w-full p-4">
          <p className="text-2xl" style={{ color:"#222222" , fontWeight: 600}}>Payouts</p>
          <div>
            <select
              id="countries"
              style={{
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-4 py-4">
                <div className={isTransaction ? "text-[#10B981]" : "text-[#FFB444]"}>
               {isTransaction ?  "Completed" : "Pending"}
                </div>
              </td>
              <td className="px-4 py-4">
                <div>
                  <button className="bg-[#4DB7FD] text-white font-[600] p-1 px-8 flex gap-3 rounded-lg" onClick={()=>setSuccess(true)}>
                 {isTransaction ? "Done" :
      ...
      <DialogDefault open={openSuccess1} handleOpen={setSuccess1}>
        <div className="flex justify-center items-center flex-col gap-[20px] mt-[30px]">
          ...
          <p className="">09:21 PM on 29 Jan 2024</p>
          </div>
          <div className='flex gap-4 my-[30px]'>
        <button className='bg-[#4DB7FD] text-white w-[180px] py-1 rounded-lg font-semibold' onClick={handleDone} >Done</button>
        <button className='bg-[#4DB7FD] text-white w-[180px] py-1 rounded-lg font-semibold' onClick={()=>setSuccess2(true)} >View Details</button>
        </div>
        </div>
      </DialogDefault>
      <DialogDefault open={openSuccess2} handleOpen={setSuccess2}>
        ...
        <button className='bg-[#4DB7FD] text-white w-[180px] py-1 rounded-lg font-semibold' onClick={handleClose} >Close</button>
        </div>
        </div>
      </DialogDefault>
    </div>
